...
static zend_function_entry libvirt_functions[] = {
    ...
    PHP_FE(libvirt_domain_get_interface_devices_mac, arginfo_libvirt_conn)
...
/*
 * Function name:   libvirt_domain_get_interface_devices_mac
 * Since version:   0.4.4
 * Description:     Function is used to get network interface devices for the domain
 * Arguments:       @res [resource]: libvirt domain resource, e.g. from libvirt_domain_lookup_by_*()
 * Returns:         list of domain interface devices
 */
PHP_FUNCTION(libvirt_domain_get_interface_devices_mac)
{
    php_libvirt_domain *domain = NULL;
    zval *zdomain;
    char *xml;
    ...
    free(get_string_from_xpath(xml, "//domain/devices/interface/mac/@address", &return_value, &retval));
    free(xml);
